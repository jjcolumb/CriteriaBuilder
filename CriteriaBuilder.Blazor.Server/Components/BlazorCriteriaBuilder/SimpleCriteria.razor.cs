...
{
    public class SimpleCriteriaBase : ComponentBase
    {
        [Inject]
        ...
        [Parameter]
        public EventCallback<CriteriaRule> CriteriaRuleModified { get; set; }
        ...
        {
            Bus.Publish(new CriteriaRuleModified { CriteriaRule = CriteriaRule });
        }
    }
}
