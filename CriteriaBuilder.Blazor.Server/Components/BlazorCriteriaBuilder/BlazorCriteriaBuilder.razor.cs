...
using CriteriaBuilder.Blazor.Server.Bus.CriteriaBuilder;
...
using CriteriaBuilder.Module.Helpers.Reflection;
...
{
    public class BlazorCriteriaBuilderBase : ComponentBase 
    {
        [Inject]
        ...
        protected override void OnInitialized()
        {
            ...
            Bus.Subscribe<CriteriaRuleModified>(CriteriaRuleModifiedHandler);
        }
        ...
        private void CriteriaRuleModifiedHandler(MessageArgs message)
        {
            UpdateXafCriteria();
        ...
        private void CreateSimpleCriteriaRule(CriteriaRule parentCriteriaRule)
        {
            ...
            dataField.Text = defaulMemberInfo.Name;
